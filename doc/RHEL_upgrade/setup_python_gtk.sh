...
# PYTHONBIN=/usr/bin/python2.4.i386
# PYGTK_INSTALL_DIR=/usr/local/tt-env/gtk2.6
...
prepend_path_element $PYGTK_INSTALL_DIR/lib/python2.4/site-packages/gtk-2.0:$PYGTK_INSTALL_DIR/lib/python2.4/site-packages PYTHONPATH $PYTHONPATH
...
export XDG_DATA_DIRS=$PYGTK_INSTALL_DIR/share/
