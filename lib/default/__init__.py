...
class Config:
    ...
    def executableShouldBeFile(self, app, executable):
        ...
        return (not interpreter.startswith("java") and not interpreter.startswith("jy")) or executable.endswith(".jar")
    ...
    def setComparisonDefaults(self, app, homeOS, namingScheme):
        ...
        app.setConfigDefault("collect_traffic_alter_response", [], "List of textual transformations to perform on response traffic")
