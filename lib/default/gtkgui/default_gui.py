...
import gtk, helpdialogs, guiplugins, guiutils, plugins, os, sys, shutil, time, subprocess, operator, types, logging
...
class InteractiveActionConfig:
    ...
    def getColourDictionary(self):
        return guiutils.GUIConfig.getDefaultColours()
        
    def getDefaultAccelerators(self):
        return guiutils.GUIConfig.getDefaultAccelerators()
