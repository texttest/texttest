...
class Config:
    ...
    def setBatchDefaults(self, app):
        ...
        app.setConfigDefault("historical_report_resources", { "default": [] }, "Which performance/memory entries should be shown as separate lines in the historical report")
    ...
    def getDefaultRemoteProgramOptions(self):
        ...
        return { "default": "", "ssh" : "-q " + sshOptions,
                 "rsync" : "-e 'ssh -x " + sshOptions + "' -av --copy-unsafe-links --delete --delete-excluded --exclude-from=" + rsyncExcludeFile, "scp": "-Crp " + sshOptions }
