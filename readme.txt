Documentation Summary:
    ...
    https://texttest.sourceforge.net currently. A new site is under construction at https://www.texttest.org. 
    ...
    In texttestlib/doc, you can find :
       ...
       c) Many people like to learn by example. There are some tips on getting started, and also learning about
          features you haven't used before, under texttestlib/doc/quick_start.txt 
...
Installation and System Requirements:
    ...
    Read the online installation guide at https://texttest.sourceforge.net. Click on the "TextTest/docs" button
    and then the "Installation Guide" at the top-left of the table.
    The lightning summary is that you need Python >= 3.9, PyGTK, tkdiff which are probably already
    installed if you're on UNIX. On Windows there is a Windows installer with all dependencies available on
    https://sourceforge.net/projects/texttest/files/.

    To install TextTest itself, you can just run "sudo pip install texttest" on UNIX platforms.
...
TEXTTEST_HOME and the Self-Tests:
    ...
    The self-tests also function as working examples as described above, read texttestlib/doc/quick_start.txt for more 
    details.
...
Other (non-standard) Open Source python modules used by TextTest and packaged with it:
    ...
    imgsize.py                    webpages generated for batch runs (Robin Friedrich, v2.2.2)
...
Plugins included:
    ...
    git.py            :   integration with Git for version control
    ...
    github.py         :   integration with GitHub for bug tracking
